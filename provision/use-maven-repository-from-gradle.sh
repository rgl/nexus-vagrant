...
// see https://docs.gradle.org/9.6.0/userguide/java_library_plugin.html
// see https://docs.gradle.org/9.6.0/userguide/maven_plugin.html
...
com_gradleup_shadow_version='9.4.2'
cat >build.gradle <<EOF
// see https://docs.gradle.org/9.6.0/userguide/java_plugin.html
// see https://docs.gradle.org/9.6.0/userguide/application_plugin.html
