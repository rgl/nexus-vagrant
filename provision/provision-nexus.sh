...
# install java.
# see https://help.sonatype.com/en/sonatype-nexus-repository-system-requirements.html#supported-java-versions
...
tar xf $nexus_tarball # NB this creates the $nexus_home (e.g. nexus-3.96.1-01) and sonatype-work directories.
rm $nexus_tarball
