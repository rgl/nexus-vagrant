...
nexus_download_sha1=de9af5330bff966b612748528f426c94a54e073c
...
tar xf $nexus_tarball # NB this creates the $nexus_home (e.g. nexus-3.39.0-01) and sonatype-work directories.
rm $nexus_tarball
